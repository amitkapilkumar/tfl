...
Repo has executable jar file **buses-0.0.1-SNAPSHOT.jar**.
Which can be executed as **java -jar buses-0.0.1-SNAPSHOT.jar**
Then webpage can be viewed over the link http://localhost:8080/display.html

As a samplle file Capture.PNG is attached which is a screenshot of UI.
